...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency 'jemoji', '~> 0.10', '>= 0.10.2'
  spec.add_runtime_dependency 'kramdown', '~> 2.2'
  spec.add_runtime_dependency 'github-pages', '~> 200'
  spec.add_runtime_dependency 'jekyll-avatar', '~> 0.5', '>= 0.5.0'
  spec.add_runtime_dependency 'jekyll-feed', '~> 0.14', '>= 0.14.0'
  spec.add_runtime_dependency 'jekyll-mentions', '~> 1.6'
  spec.add_runtime_dependency 'jekyll-redirect-from', '~> 0.16', '>= 0.16.0'
  spec.add_runtime_dependency 'jekyll-seo-tag', '~> 2.0'
  spec.add_runtime_dependency 'jekyll-gist', '~> 1.5'
  spec.add_runtime_dependency 'jekyll-coffeescript', '~> 1.1', '>= 1.1.1'
  spec.add_runtime_dependency 'jekyll-assets', '~> 3.0'
  spec.add_runtime_dependency 'jekyll-sitemap', '~> 1.4'
  spec.add_runtime_dependency 'jekyll-analytics', '~> 0.1', '>= 0.1.14'
  ...
  spec.add_development_dependency 'sprockets', '~> 3.7', '>= 3.7.2'
